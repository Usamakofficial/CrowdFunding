...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  ...
  return (
    <div className="upper_sec sm:w-[288px] w-full border-amber-700 rounded-[15px] cursor-pointer" onClick={handleClick}>
      <img src={image} alt="fund" className="w-full h-[158px] object-cover rounded-[15px]"/>

      <div className="nft-image flex flex-col p-4">
        ...
        <div className="lower_sec flex justify-between flex-wrap mt-[15px] gap-2">
